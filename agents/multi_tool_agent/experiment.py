...
# Model use for the agent
MODEL_GEMINI_2_0_FLASH = "gemini-2.0-flash"
MODEL_GPT_4O = "openai/gpt-4o"
MODEL_CLAUDE_SONNET = "anthropic/claude-3-haiku-20240307"
...
if root_agent_var_name in globals() and globals()[root_agent_var_name]:
    ...
    if __name__ == "__main__":
     try:
         asyncio.run(run_team_conversation()) # This is the main function call
     except Exception as e:
         print(f"An error occurred: {e}")
...
if 'runner_root_stateful' in globals() and runner_root_stateful:
    ...
    if __name__ == "__main__":
     try:
         asyncio.run(run_stateful_conversation()) # This is the main function call
     except Exception as e:
         print(f"An error occurred: {e}")
